...
"newRound();startReplay();startReplay();var count=starts.length;stopReplay();return {sample:sample,boundary:boundary,count:count,starts:starts,stops:stops,capture:capture.length};}};"});
