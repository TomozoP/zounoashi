...
const file='games/koe-balloon/index.html';
...
for(const shape of [[390,844],[700,700],[500,1600]]){
 ...
 for(let i=0;i<200000;i++){
  ...
  const danger=p.traps.find(m=>m.x>90&&m.x<340&&Math.abs(target-m.y)<80)||p.hazards.find(m=>m.x>85&&m.x<290&&Math.abs(target-m.y)<90);
  if(danger)target+=danger.y>target?-26:26;
  if(gate)target=Math.max(gate.top+38,Math.min(gate.bottom-38,target));
