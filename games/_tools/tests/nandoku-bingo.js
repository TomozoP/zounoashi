...
/* 0. 字と読み: どのカードも、字も読みも重ならない。魚は魚へんの字 */
{
  ...
  /* 別の読み方: 同じカードのほかの字の読みに当たると、どちらを押せばよいか決まらない。
     見つけたものをここに足していく（一般的な日本語の読みだけ。字のもとの中国での意味は入れない） */
  const ALT = {
    鮫: ['ふか'], 鱶: ['さめ'], 鰍: ['どじょう', 'いなだ'], 鯔: ['いな', 'とど'], 鮪: ['しび'], 鱓: ['ごまめ'], 鰊: ['かど'], 鯱: ['しゃちほこ'],
    鮭: ['しゃけ'], 鮴: ['めばる'], 鳧: ['かも'], 鶏: ['とり'], 鳶: ['とんび'], 鳳: ['おおとり'], 鴻: ['おおとり'], 鵤: ['いかるが'],
    鳰: ['かいつぶり'], 鴇: ['つき'], 鷂: ['はしたか'], 蝦: ['がま'], 蟇: ['ひき'], 蛙: ['かわず'], 蚋: ['ぶゆ', 'ぶと'], 蝗: ['ばった'],
    蟒: ['おろち'], 蛇: ['じゃ'], 櫟: ['くぬぎ'], 楠: ['くす'], 株: ['くいぜ'], 樺: ['かんば'], 樗: ['ぬで'], 柞: ['いす'],
    錘: ['つむ'], 鋤: ['くわ'], 皸: ['ひび'], 獺: ['うそ'], 鼯: ['ももんが'], 嚔: ['はなひる'], 竈: ['へっつい'], 甕: ['もたい'],
    螽: ['ばった'], 蠓: ['ぬかが'], 鷚: ['たひばり'],
    /* 音読み（読みは訓読みにそろえたが、音読みで当たる字がないかも見る） */
    錨: ['びょう'], 鋼: ['こう'], 鉱: ['こう'], 銅: ['どう'], 銀: ['ぎん'], 鉄: ['てつ'], 銃: ['じゅう'], 鐘: ['しょう'], 鈴: ['れい', 'りん'],
    蜩: ['ちょう'], 蛍: ['けい'], 蜂: ['ほう'], 蝉: ['せん'], 鳳: ['ほう'], 鴈: ['がん'], 鵠: ['こう'], 鶴: ['かく'], 鷺: ['ろ'],
    雹: ['あられ', 'ひょう'], 霰: ['さん'], 貂: ['ちょう']
  };
  sets.forEach(s => {
    const reads = new Map(s.list.map(f => [f.reading, f.kanji]));
    s.list.forEach(f => (ALT[f.kanji] || []).forEach(r => {
      const other = reads.get(r);
      assert.ok(!other || other === f.kanji, s.mark + ' のカード: 「' + r + '」が ' + other + ' と ' + f.kanji + ' の両方に当たる');
    }));
  });
}
