...
var ZBowlingScene=(function(){
  ...
  Scene.prototype.draw=function(ctx,W,H,data,kind,phase,elapsed,position,aim,dt,power,heightOffset){
    ...
    this.ballMeshes.forEach(function(m){m.visible=false;});var m=this.ballMeshes[kind.skin];m.visible=true;m.traverse(function(part){if(!part.material)return;var translucent=phase==='power';part.material.transparent=translucent;part.material.opacity=translucent?.45:1;part.material.depthWrite=!translucent;part.castShadow=!translucent;});m.scale.setScalar(kind.r);m.quaternion.identity();
